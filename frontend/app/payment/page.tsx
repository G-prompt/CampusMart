        ...
        <div className="site-card p-6">
          <div className="flex flex-wrap gap-3">
            {[
              ...
              <button key={tab.value} type="button" onClick={() => setSelectedTab(tab.value)} className={`rounded-[10px] px-4 py-2 text-sm font-semibold transition ${selectedTab === tab.value ? "bg-black text-white" : "bg-slate-100 text-slate-700"}`}>{tab.label}</button>
            ))}
          </div>
